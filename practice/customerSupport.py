...
# classify endpoint : define model type e.g.large -> perform better vs small -> faster
response = co.classify(  
    model='large',  
    inputs=inputs,  
    examples=examples)
    # example is array of content, there's 2 parts: 
    # 1. text string 2. label/class (sorta like summary)

print(response.classifications) # identifies segments